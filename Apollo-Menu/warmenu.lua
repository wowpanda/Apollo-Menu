...
function WarMenu.CreateMenu(id, title)
	...
	menus[id].menuFocusBackgroundColor = { r = 255, g = 0, b = 0, a = 255 }
	...
	menus[id].buttonPressedSound = { name = "LEADER_BOARD", set = "HUD_FRONTEND_DEFAULT_SOUNDSET" } --https://pastebin.com/0neZdsZ5
